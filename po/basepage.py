...
class action():
   ...
   #     'appPackage': 'com.sankuan.meituan.takeoutnew',
        'appPackage':'com.taobao.taobao',
        #aapt dump badging D:\apk.apk.
        # package和launchable-activity 就是appPacage、appActivity
#        'appActivity': 'com.sankuan.meituan.activity.Welcome',
